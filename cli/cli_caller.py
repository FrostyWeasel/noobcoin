...
t1 = threading.Thread(target=call_cli, args=('localhost', '5000', 'transactions_node_0_node_count_2.txt'))
t2 = threading.Thread(target=call_cli, args=('localhost', '5001', 'transactions_node_1_node_count_2.txt'))
